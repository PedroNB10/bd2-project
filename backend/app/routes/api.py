...
api_bp.register_blueprint(relatorio_bp, url_prefix="/relatorio")
...
api_bp.register_blueprint(orbitals_bp, url_prefix="/orbital_parameters")
api_bp.register_blueprint(crews_bp, url_prefix="/crew")
api_bp.register_blueprint(launchpads_bp, url_prefix="/launchpads")
api_bp.register_blueprint(launches_bp, url_prefix="/launches")
api_bp.register_blueprint(launchcores_bp, url_prefix="/launch_cores")
api_bp.register_blueprint(payloads_bp, url_prefix="/payloads")
api_bp.register_blueprint(starlinksatellites_bp, url_prefix="/starlink_satellites")
